...
class Storeitem
  attr_reader :item_type, :price, :hat_team
  attr_writer :hat_team

  def initialize(input_options)
    @item_type = input_options[:item_type]
    @hat_team = input_options[:hat_team]
...
item1 = Storeitem.new({ item_type: "Hat", hat_team: "Chicago Bulls", price: 12 })
item2 = Storeitem.new({ item_type: "Hat", hat_team: "Miami Heat", price: 13 })
item3 = Storeitem.new({ item_type: "Hat", hat_team: "Boston Celtics", price: 11 })
